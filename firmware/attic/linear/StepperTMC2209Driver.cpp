...
void StepperTMC2209Driver::startHoming() {
    _homing = true;
    _stepper.setSpeed(HOMING_SPEED_STEPS_PER_SEC * HOME_DIRECTION);
    DEBUG_PRINT(F("Homing started — speed: ")); Serial.print(HOMING_SPEED_STEPS_PER_SEC, 0);
...
void StepperTMC2209Driver::printDriverRegs() {
    ...
    // If these don't match what we wrote in begin(),
