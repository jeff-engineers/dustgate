  ...
  template: `
    ...
    <div class="header">
      ...
      <div class="gear-btns">
        ...
        <button class="gear-btn" (click)="goSettings()" aria-label="Settings">
    ...
    <ng-container *ngIf="ready">
      ...
      <!-- Setup wizard has never been run (or was reset) -->
      <div class="setup-prompt" *ngIf="!configured">
      ...
      <div class="scroll" *ngIf="configured">
...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  /**
   * True once the setup wizard has actually been completed (gates trained),
   * from the persisted device info rather than the live WebSocket outlets
   * array — that array starts empty on every page load until the first WS
   * status frame arrives, and stays empty for devices with gates trained but
   * no smart plugs assigned, both of which previously caused this dashboard
   * to show "Not configured" and re-prompt the wizard even on a fully set up
   * device.
   */
