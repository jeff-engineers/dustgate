...
- **Stepper driver** — either:
  ...
  - BigTreeTech TMC2209 StepStick V1.2/V1.3 — same chip, no firmware change ([§1](#bigtreetech-tmc2209-stepstick-v12v13))
...
- **DIAG** — StallGuard output. Unused; homing is on physical limit switches
  (§3 explains why StallGuard was abandoned). `PIN_TMC_DIAG` is intentionally
  undefined on the DevKitC.
